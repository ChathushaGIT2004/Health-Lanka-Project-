...
if (isset($_GET['delete']) && $_GET['delete'] == '1') {
    // Deleting the doctor and related information from the database
    $deleteDoctorQuery = "DELETE FROM doctors WHERE DoctorID = ?";
    $stmt = $con->prepare($deleteDoctorQuery);
    $stmt->bind_param("i", $doctorID);
    if ($stmt->execute()) {
        // Redirect to the doctor list page with a success message
    ...
    <div class="container">
        ...
        <div class="specialization-section">
            ...
            <div class="button-section">
                <a href="SignHospital.php?DoctorID=<?= $doctorID;?>">Add Hospital</a>
                <a href="?id=<?= $doctorID; ?>&delete=1" class="delete-button" onclick="return confirmDelete()">Delete Doctor</a>
            </div>
        </div>
    </div>
