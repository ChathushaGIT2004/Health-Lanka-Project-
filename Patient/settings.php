...
<body>
    <div class="settings-container">
        ...
        <form action="update_patient.php?PatientID=<?= urlencode($PatientID); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="emergency_contact" id="emergency_contact" value="" required>
            </div>
