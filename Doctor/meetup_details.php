...
<body>
    ...
    <div class="container">
        ...
        <div class="details-section">
            ...
            <p><strong>Rate:</strong> <?= htmlspecialchars($meetup['Rate'] == 0 ? 'Not Rated' : $meetup['Rate']); ?></p>
        </div>
        ...
        <!-- Action Button: Rate the meetup if not rated -->
        <?php if ($meetup['Rate'] == 0) { ?>
            <a href="rate_meetup.php?MeetUpID=<?= $meetup['MeetUp ID']; ?>" class="action-button">Rate this Meetup</a>
        <?php } ?>
